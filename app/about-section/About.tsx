  ...
  return (
    ...
    >
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        <AnimatedTitle
          text={
            "I ENHANCE BRAND AESTHETICS, BUILD POWERFUL WEBSITES AND ENGAGING CONTENT."
          }
          className={
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          ...
          <div className="mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Spring Boot, REST API, Spring Data JPA, Spring Security, Microservice"
                }
              />
            </div>
            <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <AnimatedBody
                text={
                  "Git, Github, Vercel, V0, Netlify, Docker, CI/CD"
                }
              />
            </div>
        ...
        <div className="mt-10 flex flex-col md:-mt-0 lg:mt-28">
          ...
          <AnimatedBody
            text="My Tech Stack"
            className="hidden sm:block absolute bottom-10 right-0 left-0 mx-auto w-[90%] text-center text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[500px] md:bottom-12 md:w-[550px] md:text-[16px]"
          />
        </div>
      </div>
    </section>
